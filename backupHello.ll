...
%struct.Animal = type { %struct.Animal_vtable* }
%struct.Animal_vtable = type { i32 (%struct.Animal*, i32)* }
@Animal_vtable = global %struct.Animal_vtable { i32 (%struct.Animal*, i32)* @say }, align 8

define %struct.Animal* @new_Animal() nounwind ssp {
    ...
    store %struct.Animal_vtable* @Animal_vtable, %struct.Animal_vtable** %4, align 8
...
define i32 @main() nounwind ssp {
    %1 = call %struct.Animal* @new_Animal()
    %2 = alloca i32, align 4
    store i32 3, i32* %2, align 4
    %3 = load i32* %2, align 4
    %4 = getelementptr inbounds %struct.Animal* %1, i32 0, i32 0
    %5 = load %struct.Animal_vtable** %4, align 8
    %6 = getelementptr inbounds %struct.Animal_vtable* %5, i32 0, i32 0
