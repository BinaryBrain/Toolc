...
%struct.Fact = type { %struct.Fact_vtable* }
%struct.Fact_vtable = type { i32 (%struct.Fact*, i32)* }
@Fact_vtable = global %struct.Fact_vtable { i32 (%struct.Fact*, i32)* @computeFactorial }, align 8

define %struct.Fact* @new_Fact() nounwind ssp {
    ...
    store %struct.Fact_vtable* @Fact_vtable, %struct.Fact_vtable** %4, align 8
...
; <label>: %8
    ...
    store %struct.Fact* %this , %struct.Fact** %10, align 4
    ...
    %17 = load %struct.Fact_vtable** %16, align 8
    %18 = getelementptr inbounds %struct.Fact_vtable* %17, i32 0, i32 0
...
define i32 @main() nounwind ssp {
    %1 = call %struct.Fact* @new_Fact()
    %2 = alloca i32, align 4
    store i32 10, i32* %2, align 4
    %3 = load i32* %2, align 4
    %4 = getelementptr inbounds %struct.Fact* %1, i32 0, i32 0
    %5 = load %struct.Fact_vtable** %4, align 8
    %6 = getelementptr inbounds %struct.Fact_vtable* %5, i32 0, i32 0
